...
class supplierClass:
    ...
    def _setup_supplier_details(self):
    ...
    def add(self):
        try:
            if self.var_sup_invoice.get()=="":
                ...
                suppliers = db_manager.search_supplier("invoice", self.var_sup_invoice.get())
                if suppliers:
                    messagebox.showerror("Error","Invoice no. is already assigned",parent=self.root)
                else:
                    db_manager.add_supplier(
                        self.var_name.get(),
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                if not suppliers:
                    ...
                    if op==True:
                        db_manager.delete_supplier(self.var_sup_invoice.get())
    ...
    def search(self):
        try:
            if self.var_searchtxt.get()=="":
                ...
                suppliers = db_manager.search_supplier("invoice", self.var_searchtxt.get())
                if suppliers:
                    self.SupplierTable.delete(*self.SupplierTable.get_children())
