...
class categoryClass:
    def __init__(self, root):
        ...
        self._setup_title_and_inputs()
        self._setup_category_details()
        self._setup_images()
        self.show()
    ...
    def _setup_title_and_inputs(self):
        ...
        Entry(self.root, textvariable=self.var_name, bg="lightyellow", font=("goudy old style", 18)).place(x=50, y=170, width=300)
    ...
    def _setup_category_details(self):
